...
export function AnimatedBeamDemo() {
  ...
  return (
    <div className="relative flex h-[570px] w-full items-start justify-center overflow-hidden rounded-lg  p-4 xl:pb-42 px-12 md:px-28" ref={containerRef}>
      <div className="flex size-full flex-col max-w-lg max-h-[170px] items-stretch justify-between gap-10 ">
        <div className="flex flex-row items-center align-middle justify-between">
          <Circle ref={div1Ref} className="size-20 bg-background  invert text-foreground">
            <Mail />
          </Circle>
          <Circle ref={div5Ref} className="size-20 bg-background  invert text-foreground">
            <ScanEye />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref} className="size-20 bg-background  invert text-foreground">
            <FileKey2 />
          </Circle>
          <Circle ref={div4Ref} className="size-24 bg-background border-accent/50 border-2">
            <Image src="/images/ezemblem.png" alt="Ezoic Logo" width={100} height={100} />
          </Circle>
          <Circle ref={div6Ref} className="size-20 bg-background  invert text-foreground">
            <MonitorCheck />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref} className="size-20 bg-background  invert text-foreground">
            <Fingerprint />
          </Circle>
          <Circle ref={div7Ref} className="size-20 bg-background  invert text-foreground">
            <CircleDollarSign />
          </Circle>
        </div>
      </div>
