...
export default function GridCard({color, title, excerpt, image, link}: GridCardProps) {
  return (
    ...
    >
      <div className={cn("flex w-full bg-dots flex-col justify-between overflow-hidden transition ease-in-out border rounded-3xl p-4", color === "primary" ? "group-hover:border-primary-foreground/50" : " group-hover:opacity-80")}>
        <div>
        ...
        <Button className="mt-6 w-1/3" size="sm" variant={stegaClean(link?.buttonVariant)} asChild>
